...
- Inventory control
- Purchase tracking
- Supplier & warehouse records
- Payment handling (Cash and GCash)
...
- **ORM:** Sequelize  
- **Middleware:** Multer (file uploads), CORS, Express Validator  
- **Other:** dotenv, nodemon (dev), bcrypt (optional for security)
